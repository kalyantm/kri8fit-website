        ...
        <div className="py-12 md:py-16 border-t border-gray-200 dark:border-gray-800 -mt-px">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-2 md:ml-4 md:mb-0">
              <li>
                <a
                  className="flex justify-center items-center text-white bg-[#85f193] dark:text-black dark:bg-[#85f193] hover:underline hover:bg-teal-600 rounded-full transition duration-150 ease-in-out"
                  href="#0"
                  aria-label="Twitter"
                >
                  <svg
          ...
          <div className="flex flex-col justify-center items-center md:flex-row lg:flex-row md:justify-start lg:justify-start baseline gap-4 mt-4">
            <button
              type="button"
