              ...
              <div className="relative flex flex-col items-start z-10 transition-all duration-300 ease-in-out" ref={testimonials}>
                ...
                {items.map((item, index) => (
                  <Transition
                    ...
                    as="div"
                    show={active === index}
                    className={`w-full text-center px-12 py-8 mx-4 md:mx-0 transform transition ease-in-out data-closed:absolute data-enter:data-closed:-translate-y-8 data-leave:data-closed:translate-y-8 data-closed:opacity-0 data-enter:duration-700 data-leave:duration-300`}
                    unmount={false}
                    appear={true}
                  >                       
