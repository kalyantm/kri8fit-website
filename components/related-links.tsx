export default function RelatedLinks() {
  return (
    <section className="relative border-t border-gray-200 dark:border-gray-800">
      {/* Background gradient */}
      <div className="absolute inset-0 dark:opacity-25 bg-linear-to-b from-gray-100 to-white dark:from-gray-800 dark:to-gray-900 pointer-events-none" aria-hidden="true"></div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-xs sm:max-w-none mx-auto md:max-w-none lg:max-w-none grid gap-4 md:gap-6 sm:grid-cols-2 md:grid-cols-3" data-aos-id-rellinks>
            ...
            {/* 1st item */}
            <a className="flex flex-col items-center text-center p-5 text-white group bg-linear-to-tr from-teal-500 to-teal-400 dark:to-teal-500 shadow-2xl" href="#0" data-aos="fade-down" data-aos-anchor="[data-aos-id-rellinks]">
            ...
            {/* 2nd item */}
            <a className="flex flex-col items-center text-center p-5 text-white group bg-linear-to-tr from-purple-500 to-purple-400 dark:to-purple-500 shadow-2xl" href="#0" data-aos="fade-down" data-aos-anchor="[data-aos-id-rellinks]" data-aos-delay="150">
              <svg className="w-8 h-8 mb-3" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* 3rd item */}
            <a className="flex flex-col items-center text-center p-5 text-white group bg-linear-to-tr from-indigo-500 to-indigo-400 dark:to-indigo-500 shadow-2xl sm:col-span-2 md:col-auto" href="#0" data-aos="fade-down" data-aos-anchor="[data-aos-id-rellinks]" data-aos-delay="300">
              <svg className="w-8 h-8 mb-3" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
