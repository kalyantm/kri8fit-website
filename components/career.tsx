...
export default function Career() {  
  return (
    <section className="relative border-t border-gray-200 dark:border-gray-800">
      {/* Background gradient */}
      <div className="absolute inset-0 opacity-25 bg-linear-to-b from-gray-100 to-white dark:from-gray-800 dark:to-gray-900 pointer-events-none" aria-hidden="true"></div>
              ...
              <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                ...
                <a className="block group" href="#0">
                  <div className="relative h-0 pb-9/16 sm:pb-1/1">
                    ...
                    <div className="absolute inset-0 opacity-75 bg-linear-to-t from-gray-900" aria-hidden="true"></div>
