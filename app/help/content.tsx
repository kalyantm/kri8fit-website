          ...
          <div data-aos="fade-up" data-aos-delay="450">
            ...
            <div className="mb-10">
              <div className="flex flex-wrap justify-center -m-1">
                <button
                  className="font-medium px-4 py-2 bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 shadow-sm transition duration-150 ease-in-out rounded-full inline-flex items-center justify-center m-1"
                  onClick={() => setCategory('')}
                >
                ...
                <button
                  className={`font-medium px-4 py-2 shadow transition duration-150 ease-in-out rounded-full inline-flex items-center justify-center m-1 ${
                    category === '2' ? 'bg-purple-500 hover:bg-purple-500 dark:bg-purple-600/25 dark:hover:bg-purple-600/25' : 'bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700'
                  }`}
                ...
                <button
                  className={`font-medium px-4 py-2 shadow transition duration-150 ease-in-out rounded-full inline-flex items-center justify-center m-1 ${
                    category === '3' ? 'bg-indigo-500 hover:bg-indigo-500 dark:bg-indigo-600/25 dark:hover:bg-indigo-600/25' : 'bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700'
                  }`}
                ...
                <button
                  className={`font-medium px-4 py-2 shadow transition duration-150 ease-in-out rounded-full inline-flex items-center justify-center m-1 ${
                    category === '4' ? 'bg-pink-500 hover:bg-pink-500 dark:bg-pink-600/25 dark:hover:bg-pink-600/25' : 'bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700'
                  }`}
